...
export const NavigationSidebar = ({ user, activeProfile, isAdmin, page, setPage, onLoginClick, onSignOut }) => {
    ...
    const navItems = [
        ...
        { name: 'profile', label: 'Profile', icon: <IconProfile />, adminOnly: false }, 
        { name: 'calculator', label: 'Calculator', icon: <IconCalc />, adminOnly: false },
        { name: 'mastersheet', label: 'Mastersheet', icon: <IconMastersheet />, adminOnly: false },
        { name: 'leaderboards', label: 'Leaderboards', icon: <IconTrophy />, adminOnly: false },
...
const IconProfile = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="7" r="4"/><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/></svg>;
...
const IconMastersheet = () => <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>;
